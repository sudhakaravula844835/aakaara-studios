...
def optimize_images(folder_path, backup_dir=None, max_width=1920, quality=70, webp_quality=75, watermark_path=None, watermark_opacity=0.15):
            ...
            if file.lower().endswith(('.jpg', '.jpeg', '.png')) and not file.lower().startswith('._'):
                ...
                try:
                    with Image.open(file_path) as img:
                        ...
                        # 0. Fix orientation based on EXIF before stripping it
...
if __name__ == "__main__":
    # Locate the images directory relative to the project root (one level up from build/)
    PROJECT_ROOT = Path(__file__).parent.parent
    images_dir = PROJECT_ROOT / "images"
    backup_dir = PROJECT_ROOT / "images_original_backup"
